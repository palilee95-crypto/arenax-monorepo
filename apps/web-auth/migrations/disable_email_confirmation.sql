-- 1. Function to auto-confirm email on signup
CREATE OR REPLACE FUNCTION public.auto_confirm_email()
RETURNS TRIGGER AS $$
BEGIN
  -- Set email_confirmed_at and confirmed_at to bypass confirmation
...
-- 2. Trigger to call the function before auth.users insert
...
-- 3. Update handle_new_user_onboarding to set status to 'verified'
...
BEGIN
    ...
    INSERT INTO public.profiles (
        ...
        v_position,
        v_skill_level,
        'verified' -- Set to verified immediately
    )
