...
export const TopBar = ({ userName, userRole, avatarUrl, statusBadge, onMenuClick, profileHref, settingsHref }: TopBarProps) => {
                    ...
                    {isMenuOpen && (
                        <div className="user-menu-dropdown">
                            ...
                            <div className="menu-items">
                                <a href={profileHref || `/${userName}/profile`} className="menu-item">
                                ...
                                <a href={settingsHref ? `${settingsHref}?tab=notifications` : `/${userName}/settings?tab=notifications`} className="menu-item">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                ...
                                <a href={settingsHref || `/${userName}/settings`} className="menu-item">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
